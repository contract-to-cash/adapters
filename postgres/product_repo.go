...
//
// Products are master data — read-heavy and modified infrequently. The
// repository stores the full set of nested collections (features,
// usage_metrics, metadata) as JSONB to keep the schema simple.
...
// FindByID loads a product by ID.
